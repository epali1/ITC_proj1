...
def to_database(data):
    ...
    for i in range(0, len(file_data)):
        ...
        try    : Single_2  = Selfie_Cam['Single'] 
        except : Single_2 = ""  
        try    : Features_2 = Selfie_Cam['Features']
        except : Features_2 = ""
        try    : Video_2 = Selfie_Cam['Video']  
        except : Video_2 = ""
        #=> Misc
        ...
        try    : Card_slot = Battery['Card slot']  
        except : Card_slot = "" 
        try    : Internal = Battery['Internal']  
        except : Internal = ""  
        try    : Other = Battery['other']  
        except : Other = ""
        # Query 1 : Battery
